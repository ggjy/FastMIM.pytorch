...
def swin_small_patch4_window7_224(pretrained=False, **kwargs):
    ...
    return SwinTransformer(pretrained=pretrained, **model_kwargs)
...
@register_model
def swin_large_patch4_window14_224(pretrained=False, **kwargs):
    """ Swin-S @ 224x224, trained ImageNet-1k
    """
    model_kwargs = dict(
        patch_size=4, window_size=14, embed_dim=192, depths=(2, 2, 18, 2), num_heads=(6, 12, 24, 48), **kwargs)
    return SwinTransformer(pretrained=pretrained, **model_kwargs)
